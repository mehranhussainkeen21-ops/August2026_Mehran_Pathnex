Day - 19 Advance Monetoring, Logging, and Security
 Ansible - Setup Prometheus for Monetoring
 - name: Install Prometheus for Monetoring
 hosts: all
 become: yes
 tasks:
 ...
 state: started
 enabled: yes
  Terraform - setup AWS CloudWatch for Monetoring
