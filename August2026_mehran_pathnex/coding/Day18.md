# Dsay 18 - High Avalibility, Multi-region, and Auto-Scaling

##  Ansible - Cinfigure HAProxy for Load Balancer

```yaml
- name: Setup HAProxy Load Balencer
host: all
become: yes
tasks:
